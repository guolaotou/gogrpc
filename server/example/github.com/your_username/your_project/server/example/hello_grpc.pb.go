...
func (UnimplementedHelloServiceServer) SayHello(ctx context.Context, r *HelloRequest) (*HelloResponse, error) {

	// return some useful
	return &HelloResponse{Message: fmt.Sprintf("Hello %s", r.Name)}, nil
